#This code contains snake image. visit: https://replit.com/@devmoh04/snake-game-1#snake.jpg for image 
import pygame
import random
import os
import playsound
...
# Game Title
pygame.display.set_caption("Snake By Devendra")
...
def welcome():
    ...
    while not exit_game:
        ...
        text_screen("This game is made by Devendra", black, 180, 160)
...
def gameloop():
    ...
    while not exit_game:
        if game_over:
            ...
            text_screen("Score: " + str(score) + "  Highest score: " + str(hiscore),
                        red, 5, 5)
